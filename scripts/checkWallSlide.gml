...
if (argument[0] > 0) {
    var instance    = collision_line(bbox_right + 3, bbox_top, bbox_right + 3, bbox_bottom, objPlatforms, true, true);
    var oldInstance = collision_line(bbox_right, bbox_top, bbox_right, bbox_bottom, objPlatforms, true, true);
} else if (argument[0] < 0) {
    var instance    = collision_line(bbox_left - 3, bbox_top, bbox_left - 3, bbox_bottom, objPlatforms, true, true);
